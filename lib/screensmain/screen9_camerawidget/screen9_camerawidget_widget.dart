...
import 'screen9_camerawidget_model.dart';
export 'screen9_camerawidget_model.dart';

class Screen9CamerawidgetWidget extends StatefulWidget {
  const Screen9CamerawidgetWidget({
    Key? key,
    this.fatParameter,
  }) : super(key: key);
  ...
  @override
  _Screen9CamerawidgetWidgetState createState() =>
      _Screen9CamerawidgetWidgetState();
}

class _Screen9CamerawidgetWidgetState extends State<Screen9CamerawidgetWidget> {
  late Screen9CamerawidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Screen9CamerawidgetModel());
  }
          ...
          children: [
            ...
            Align(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(8.0),
                child: Image.network(
                  'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/balance-her-smfckc/assets/5z8lnz6jrjms/Black_and_White_Simple_Technology_Mobile_Prototype-23.png',
                  width: 300.0,
                  height: 141.0,
                  fit: BoxFit.cover,
